...
include('is_logged.php');//Archivo verifica que el usario que intenta acceder a la URL esta logueado
	...
	if (empty($_POST['codigo_nuevo'])) {
		...
		$sql="INSERT INTO products (codigo_producto, nombre_producto, marca, codigo_barra, ingrediente,detalle,nutricion,fecha,etiqueta,medida_nutricion,porcion_nutricion,vencimiento) VALUES (UPPER('$codigo_nuevo'),'$codigo_nuevo','$marca','$codigo_nuevo','$ingrediente','$detalle','$nutricion','$fecha','$etiqueta','$medida_nutricion','$porcion_nutricion','$vencimiento')";
		...
		$query_new_insert = mysqli_query($con,$sql);
				...
				$sql="INSERT INTO products_nutricion (codigo_producto, nombre, medida, porcion) VALUES (UPPER('$codigo_nuevo'),'$nombre','$medida','$porcion')";
