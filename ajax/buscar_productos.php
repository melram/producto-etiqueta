			...
			<div class="table-responsive">
			  <table class="table table-hover table-striped">
				...
				while ($row=mysqli_fetch_array($query)){					
					...
					<button class="btn btn-primary" onclick="imprimir_eti('<?php echo $codigo_producto?>','<?php echo $etiqueta?>')"><i class="glyphicon glyphicon-print"></i></button>
					<a href="edit_productos.php?codigo_producto=<?php echo $codigo_producto ?>" class='btn btn-success' title='Editar producto'><i class="glyphicon glyphicon-edit"></i></a> 
					<button class='btn btn-danger' title='Borrar producto' onclick="eliminar('<?php echo $codigo_producto; ?>')"><i class="glyphicon glyphicon-trash" disabled></i></button></span></td>
					</tr>
					<?php
				}
				?>
